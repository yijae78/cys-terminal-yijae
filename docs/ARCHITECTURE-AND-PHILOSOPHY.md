...
- 설치 상세: [INSTALL.md](INSTALL.md) · [INSTALL-Windows-KR.md](INSTALL-Windows-KR.md)
- 무중단 팩 업데이트 설계 정본: [DESIGN-noshutdown-pack-update.md](DESIGN-noshutdown-pack-update.md)
- Control Center 설계: [CONTROL_CENTER_DESIGN.md](CONTROL_CENTER_DESIGN.md)
